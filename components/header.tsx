...
const Header = () => {
    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between py-4">
        ...
        <div className="hidden sm:flex sm:items-center">
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Find a Tutor</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Courses</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Group Session</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600">Enroll as a Tutor</a>
        </div>
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
    ...
    <div className="mt-5 sm:flex gap-4 md:mt-8">
